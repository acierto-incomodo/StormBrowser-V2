...
async function afterPackageBuilt (path, arch) {
  var installerOptions = {
    artifactName: 'stormbrowser-${version}-${arch}.deb',
    packageName: 'stormbrowser',
    ...
    description: 'StormBrowser is a fast, stormbrowserimal browser that protects your privacy.',
